<%-- 
    ...
    Created on : Mar 8, 2022, 10:04:09 AM
    Author     : msi
--%>
        ...
        <div class="container-fluid" style=" background-color: #fff; padding: 11px;">
            <div class="row">
                <div class="col-lg-2 order-lg-1 order-2">
                    <ul class="image_list">
                        <li data-image="https://i.imgur.com/21EYMGD.jpg"><img src="${detail.image}" alt=""></li>
                        <li data-image="https://i.imgur.com/DPWSNWd.jpg"><img src="${detail.image}" alt=""></li>
                        <li data-image="https://i.imgur.com/HkEiXfn.jpg"><img src="${detail.image}" alt=""></li>
                    </ul>
                </div>
                <div class="col-lg-4 order-lg-2 order-1">
                    <div class="image_selected"><img src=${detail.image} alt=""></div>
                </div>
                <div class="col-lg-6 order-3">
                    <div class="product_description">
                        ...
                        <div> <span class="product_price">${detail.price}</span> <strike class="product_discount"> <span style='color:black'>₹ 2,000<span> </strike> </div>
                        <div> <span class="product_saved">You Saved:</span> <span style='color:black'>₹ 2,000<span> </div>
                        <hr class="singleline">
                        <div> <span class="product_info">${detail.description}<span><br><!--
<span class="product_info">Warranty: 6 months warranty<span><br> <span class="product_info">7 Days easy return policy<span><br> <span class="product_info">7 Days easy return policy<span><br> <span class="product_info">In Stock: 25 units sold this week<span> </div>-->
<!--                        <div>
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="br-dashed">
