    ...
    <body>
        <div id="logreg-forms">
            ...
            <form action="signup" method="post" class="form-signup">
                <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Tạo tài khoản</h1>
                ...
                <button class="btn btn-primary btn-block" type="submit"><i class="fas fa-user-plus"></i> Tạo tài khoản</button>
